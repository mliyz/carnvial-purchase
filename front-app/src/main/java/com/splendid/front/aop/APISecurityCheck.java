package com.splendid.front.aop;

import com.splendid.common.service.JedisUtil;
import com.splendid.front.security.JWTUtils;
...
public class APISecurityCheck {
    ...
    private Logger logger = LoggerFactory.getLogger(APISecurityCheck.class);
    ...
    public void doBeforeInService(JoinPoint joinPoint) throws Exception{
        ...
        //需要过滤URL的请求，有些不需要token的地方直接跳过不再校验
